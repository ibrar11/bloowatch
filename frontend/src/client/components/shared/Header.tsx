      ...
      <Container>
        <div data-testid="header_content" className="bloowatch-header__content">
          ...
          <div
            ...
            className={
              mobileMenu
                ? "bloowatch-header__mobile-menu"
                : "bloowatch-header__nav-list"
            }
          >
            <li>
              <Link
            ...
            {userData?.accessToken ? (
              <React.Fragment>
                ...
                <li className="bloowatch-header__dropdown">
                  <div
                    className="bloowatch-header__dropdown-name"
                  ...
                  {showDropDown && (
                    <div
                      ...
                      className="bloowatch-header__dropdown-content"
                    >
                      <Link to="/edit-user" onClick={EditProfile}>
                        Edit Profile
                      </Link>
                ...
                {showDropDown && (
                  <div
                    data-testid="screen_wrapper"
                    onClick={() => setShowDropDown(!showDropDown)}
                    className="bloowatch-screen__wrapper"
                  />
                )}
              </React.Fragment>
            ) : (
          ...
          {mobileMenu && (
            <div
              data-testid="mobile_screen_wrapper"
              onClick={() => setMobileMenu(!mobileMenu)}
              className="bloowatch-mobile-screen__wrapper"
            />
          )}

          <div
            data-testid="hamburger_menu"
            className="bloowatch-header__mobile-view"
          >
            <GiHamburgerMenu
              data-testid="hamburger_menu_icon"
              onClick={() => setMobileMenu(!mobileMenu)}
            />
          </div>
        </div>
