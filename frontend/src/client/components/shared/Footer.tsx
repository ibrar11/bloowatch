...
const Footer = () => {
  return (
    <footer data-testid="footer" className="bloowatch-footer">
      <Container>
        <div
          data-testid="footer__wrapper"
          className="bloowatch-footer__wrapper"
        >
          <div data-testid="footer-col" className="bloowatch-footer__col">
            <h3>About</h3>
            <p data-testid="bloowatch_text">
              Bloowatch is specialized software for watersports schools
              (surfing. kitesurfing. sailing. and diving) and outdoor activity
              providers (sking, climbing)
            </p>
          </div>
          <div data-testid="footer-col" className="bloowatch-footer__col">
            <h3>Contact</h3>
          ...
          <div data-testid="footer-col" className="bloowatch-footer__col">
            ...
            <div
              data-testid="images"
              className="bloowatch-footer__insta-images"
            >
